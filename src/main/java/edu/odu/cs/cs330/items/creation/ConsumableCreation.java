...
public class ConsumableCreation implements ItemCreationStrategy
{
    ...
    {
        Consumable originalConsumable = (Consumable) original;
        Consumable cpy = new Consumable();

        cpy.setName(originalConsumable.getName());
        cpy.setEffect(originalConsumable.getEffect());
        cpy.setNumberOfUses(originalConsumable.getNumberOfUses());
